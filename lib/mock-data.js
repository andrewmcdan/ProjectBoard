// Older sample data kept around for quick UI experiments without the database.
export const boardColumns = [
    {
        ...
        features: [{ id: "FEATURE-03", title: "Authentication Flow", assignee: "Andrew", priority: "High" }],
    },
    {
        id: "in-progress",
        name: "In Progress",
        className: "statusProgress",
        issues: [{ id: "ISSUE-11", title: "Build dashboard layout", assignee: "Maya", priority: "High", feature: "Project Dashboard" }],
        features: [{ id: "FEATURE-01", title: "Project Dashboard", assignee: "Maya", priority: "High" }],
    },
    {
        id: "done",
        name: "Done",
        className: "statusDone",
        issues: [{ id: "ISSUE-02", title: "Draft term project overview", assignee: "Andrew", priority: "Done", feature: null }],
        features: [{ id: "FEATURE-00", title: "Term Project Definition", assignee: "Andrew", priority: "Done" }],
    },
];
