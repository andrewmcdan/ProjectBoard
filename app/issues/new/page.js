            ...
            <section className="page-card">
                ...
                <form action={createIssueAction}>
                    ...
                    <div className="form-fields">
                        ...
                        <Selects members={project.members} features={project.features} featureId={featureId} />
                    </div>
                    <LabelChoices labels={project.labels} />
                    <label className="form-field">
...
function Selects({ members, features, featureId }) {
    return (
        <>
            <label className="form-field">
                <span>Status</span>
